...
public class AddEmployee extends JFrame implements ActionListener{
	...
	AddEmployee(){
		...
		r1.setBackground(new Color(104,144,136));
		r1.setBounds(200,130,70,30);
		add(r1);
		
		r2 = new JRadioButton("Female");
		r2.setFont(new Font("Tahoma",Font.PLAIN,10));
		r2.setBackground(new Color(104,144,136));
		...
		String str[] = {"Manager","Chef","HouseKeeping","Kitchen Staff","Room Service","Waiter/Waitress","Accountant","Doorman","Security","Concierge"};
		...
		l1.setBounds(400,0,590,500);
		add(l1);
		
		getContentPane().setBackground(new Color(104,144,136));
		
		setLayout(null);
		setBounds(180,160,1000,500);
		setVisible(true);
	}
	public void actionPerformed(ActionEvent ae) {
	    ...
	    try {
	    	 ...
	    	 JOptionPane.showMessageDialog(null,"New Employee Addded");
